  ...
  <div class="pelanggan-area py-5 "> 
    ...
    <div class="card shadow-lg border-0 rounded-4 mx-auto" style="max-width: 900px" > 
      <div class="card-header bg-info text-white fw-semibold fs-2 py-3" > 
        <!-- 🔍 Riwayat Cucian & Antar Jemput  -->
         <i class="fas fa-history" id="ikon"></i> <p id="text">Riwayat Cucian & Antar Jemput</p> 
      </div> 
      <div class="card-body p-9"> 
        <form @submit.prevent="lihatRiwayat"> 
          <div class="mb-6"> 
            ...
            <small class="text-muted fs-6"> 
              Masukkan nomor telepon yang terdaftar untuk melihat riwayat pesanan dan layanan antar-jemput 
            </small> 
          </div> 
...
const lihatRiwayat = () => { 
  if (!nomorTelepon.value) return; 
  alert(`Menampilkan riwayat untuk nomor: ${nomorTelepon.value}`); 
  // Di sini Anda bisa menambahkan logika untuk mengambil data riwayat dari API
}; 
</script> 
