            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="fv-row mb-8">
                        ...
                        <!--begin::Input-->
                        <file-upload v-bind:files="files.logo" :accepted-file-types="fileTypes" 
                    ...
                    <div class="fv-row mb-8">
                        ...
                        <!--begin::Input-->
                        <file-upload v-bind:files="files.bgAuth" :accepted-file-types="fileTypes"
